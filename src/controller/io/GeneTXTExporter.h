...
private:
    ...
    void exportItem(QTextStream &otxt, const FeaturePtr &feature, const QObject &context) const;
    void exportItem(QTextStream &otxt, const FeatureList &featureList, const QObject &context) const;
