...
namespace GL
{
    ...
    #define GLcirclecolor GLcolordata
    // typedef GLcolordata<N> GLcirclecolor<N>;
...
namespace GL
{
    ...
    // simple colors
    inline GLubyte alpha(const GLrgb argb) { return ((argb >> 24) & 0xFFu); }
    inline GLubyte red(const GLrgb argb) { return ((argb >> 16) & 0xFFu); }
    inline GLubyte green(const GLrgb argb) { return ((argb >> 8) & 0xFFu); }
    inline GLubyte blue(const GLrgb argb) { return ((argb >> 0) & 0xFFu); }
