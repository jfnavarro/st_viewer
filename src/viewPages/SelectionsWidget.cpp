    ...
    QWidget(parent)
{
    ...
    m_saveSelection = new QPushButton();
    ...
    m_exportSelection = new QPushButton();
    ...
    m_clearSelection = new QPushButton();
    ...
    m_geneSelectionFilterLineEdit = new QLineEdit();
    ...
    m_selections_tableview = new GeneSelectionTableView();
